...
module CliProject =
    ...
    let projectPath = "src/Cli.fsproj"
    ...
    Target.create metaTarget (fun _ ->
        ...
        [
            ...
            "    <PackageProjectUrl>https://github.com/gretmn102/VideoReviewCreator/tree/main/src</PackageProjectUrl>"
            "    <PackageLicenseExpression>MIT</PackageLicenseExpression>"
            "    <RepositoryUrl>https://github.com/gretmn102/VideoReviewCreator.git</RepositoryUrl>"
            sprintf "    <PackageReleaseNotes>%s</PackageReleaseNotes>"
                (String.concat "\n" release.Notes |> XmlText.escape)
            "    <PackageTags>fsharp;cli</PackageTags>"
            "    <Authors>agentlapki</Authors>"
...
try
    Target.runOrDefault CliProject.deployTarget
with _ ->
